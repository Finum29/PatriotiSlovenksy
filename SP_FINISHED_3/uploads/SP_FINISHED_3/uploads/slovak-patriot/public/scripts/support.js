...
async function submitTicket(e) {
  ...
  try {
    ...
    if (data.ok) {
      messageDiv.innerHTML = '<div class="success-message">Ticket submitted successfully! Our team will respond soon. You can check your tickets in your profile.</div>';
